...
const saveList = (list, Exchange) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const save = (item, Exchange) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const o = Exchange
            .build({ timestamp: item.timestamp, symbol: item.symbol, open: item.open, high: item.high,
            low: item.low, close: item.close, volume_USD: item.volume_USD, volume_BTC: item.volume_BTC });
...
//# sourceMappingURL=bitsService.js.map